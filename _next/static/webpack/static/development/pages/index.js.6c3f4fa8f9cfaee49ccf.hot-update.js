...
var Board = function Board() {
  ...
  var generateMaze = function generateMaze() {
    ...
    lodash__WEBPACK_IMPORTED_MODULE_3__["each"](new Array(ROWS), function (_row, rowIndex) {
      ...
      lodash__WEBPACK_IMPORTED_MODULE_3__["each"](new Array(COLS), function (_col, colIndex) {
        var randomness = !!lodash__WEBPACK_IMPORTED_MODULE_3__["round"](Math.pow(Math.random(), 2));
        if (rowIndex === FINISH_ROW && colIndex === FINISH_COL) randomness = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_0__["default"])("randomness"), false);
...
//# sourceMappingURL=index.js.6c3f4fa8f9cfaee49ccf.hot-update.js.map