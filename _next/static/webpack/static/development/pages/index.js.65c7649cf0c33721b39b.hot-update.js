...
var Node = function Node(props) {
  var _useDrag = Object(react_dnd__WEBPACK_IMPORTED_MODULE_3__["useDrag"])({
    ...
    collect: function collect(monitor) {
      ...
      dragRef = _useDrag2[1]; // const [, dropRef] = useDrop({
  //   accept: { type: 'NODE' },
  //   drop: () => ({ name: 'BOX' }),
  //   collect: (monitor) => ({
...
//# sourceMappingURL=index.js.65c7649cf0c33721b39b.hot-update.js.map