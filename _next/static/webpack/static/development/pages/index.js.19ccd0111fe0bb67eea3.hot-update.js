...
function getNeighbors(node, grid) {
  ...
  return lodash__WEBPACK_IMPORTED_MODULE_0__["filter"](neighbors, function (neighbor) {
    return !neighbor.isVisited && !node.isWall;
  });
}
...
function Dijkstra(grid, startNode, endNode) {
  ...
  while (unVisitedNodes.length) {
    ...
    var currentNode = unVisitedNodes.shift(); // if (currentNode.isWall) continue;
...
//# sourceMappingURL=index.js.19ccd0111fe0bb67eea3.hot-update.js.map